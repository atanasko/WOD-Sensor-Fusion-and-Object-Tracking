...
def read_cam_img_df(dataset_dir: str, context_name: str, camera_name: int):
...
def read_camera_calibration_df(dataset_dir: str, context_name: str, camera_name: int):
    camera_calibration_df = read_df(dataset_dir, context_name, 'camera_calibration')
    camera_calibration_df = camera_calibration_df[camera_calibration_df['key.camera_name'] == camera_name]

    return camera_calibration_df
